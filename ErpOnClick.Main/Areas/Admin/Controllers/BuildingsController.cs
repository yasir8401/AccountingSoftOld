...
namespace ErpOnClick.Main.Areas.Admin.Controllers
{
    ...
    public class BuildingsController : Controller
    {
        ...
        public BuildingsController(IBuildingsService BuildingsService, IBranchService BranchService, ICompanyService CompanyService, ILookupsService lookupsService)
        {
