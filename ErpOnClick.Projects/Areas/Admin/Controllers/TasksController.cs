...
namespace ErpOnClick.Tasks.Areas.Admin.Controllers
{
    [Area("Admin")]
    [Authorize]
    public class TasksController : Controller
    {
        ...
        public TasksController(ILogger<TasksController> logger, IProjectService projectService, IEmpsService empService, IVacantJobsService VacantJobsService, IBranchService BranchService, ICompanyService CompanyService, ITaskService TaskService, ILookupsService LookupService, ILookupTypesService LookupTypesService)
        {
            _logger = logger;
