...
using ErpOnClick.Projects.ViewModel;
using Microsoft.AspNetCore.Localization;

namespace ErpOnClick.TeamMembers.Areas.Admin.Controllers
{
    [Area("Admin")]
    [Authorize]
    public class ProjectDetailController : Controller
    {
        ...
        public IActionResult _list()
        {
            ...
            //string sourcePath = @"C:\Hamza Nayel\NayelSourceCodes\ErpOnClick\ErpOnClick.HR\wwwroot\Files";
