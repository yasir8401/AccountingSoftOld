...
namespace ErpOnClick.Invoicing.Areas.Admin.Controllers
{
    ...
    public class ItemsController : Controller
    {
        ...
        public ItemsController(ILogger<ItemsController> logger, ICompanyService CompanyService, IBranchService BranchService, IItemsService ItemsService, IItemCategoriesService ItemCategoriesService)
        {
            _logger = logger;
