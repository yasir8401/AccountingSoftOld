...
namespace ErpOnClick.Invoicing.Areas.Admin.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public CustomersController(ILogger<CustomersController> logger, ICompanyService CompanyService, IBranchService BranchService, ILookupsService LookupTypesService, ICustomersService CustomersService, IAccountsService AccountsService)
        {
            _logger = logger;
