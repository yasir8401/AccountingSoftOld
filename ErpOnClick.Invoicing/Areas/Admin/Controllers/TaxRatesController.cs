...
namespace ErpOnClick.Invoicing.Areas.Admin.Controllers
{
    ...
    public class TaxRatesController : Controller
    {
        ...
        public TaxRatesController(ILogger<TaxRatesController> logger, ICompanyService CompanyService, IBranchService BranchService, ILookupsService LookupTypesService, ITaxRatesService TaxRatesService)
        {
            _logger = logger;
