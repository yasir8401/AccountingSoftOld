...
namespace ErpOnClick.Invoicing.Areas.Admin.Controllers
{
    ...
    public class ItemCategoriesController : Controller
    {
        ...
        public ItemCategoriesController(ILogger<ItemCategoriesController> logger, ICompanyService CompanyService, IBranchService BranchService, IItemCategoriesService ItemCategoriesService)
        {
            _logger = logger;
