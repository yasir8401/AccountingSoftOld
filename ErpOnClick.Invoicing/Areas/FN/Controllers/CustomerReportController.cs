...
namespace ErpOnClick.Invoicing.Areas.FN.Controllers
{
    ...
    public class CustomerReportController : Controller
    {
        ...
        public CustomerReportController(ILogger<CustomerReportController> logger, ICustomersService CustomersService, IAccountsService accountsService, IGeneralEntriesLinesService generalEntriesLinesService, ICompanyService CompanyService, IBranchService BranchService,  IAccountTypesService AccountTypesService, IAccountGroupsService AccountGroupsService)
        {
            _logger = logger;
