...
namespace ErpOnClick.Invoicing.Areas.FN.Controllers
{
    ...
    public class AccountGroupsController : Controller
    {
        ...
        public AccountGroupsController(ILogger<AccountGroupsController> logger, ICompanyService CompanyService, IBranchService BranchService, IAccountGroupsService AccountGroupsService)
        {
            _logger = logger;
