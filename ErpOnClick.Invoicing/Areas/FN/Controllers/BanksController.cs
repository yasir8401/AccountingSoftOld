...
namespace ErpOnClick.Invoicing.Areas.FN.Controllers
{
    ...
    public class BanksController : Controller
    {
        ...
        public BanksController(ILogger<BanksController> logger, ICompanyService CompanyService, IBranchService BranchService, ILookupsService LookupTypesService, IBanksService BanksService, IAccountsService AccountsService)
        {
            _logger = logger;
