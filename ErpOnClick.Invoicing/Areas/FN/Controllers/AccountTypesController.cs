...
namespace ErpOnClick.Invoicing.Areas.FN.Controllers
{
    ...
    public class AccountTypesController : Controller
    {
        ...
        public AccountTypesController(ILogger<AccountTypesController> logger, ICompanyService CompanyService, IBranchService BranchService, IAccountTypesService AccountTypesService)
        {
            _logger = logger;
