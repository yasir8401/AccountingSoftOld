...
namespace ErpOnClick.Invoicing.Models
{
    public class DashboardViewModel
    {
        ...
        public void Build(List<Customers> customers,List<Vendors> vendors,List<AccountTypes> accountTypes,List<Accounts> accounts, List<IGrouping<Accounts, GeneralEntriesLines>> generalEntriesList, List<ItemCategories> itemCategories, List<Items> items)
        {
