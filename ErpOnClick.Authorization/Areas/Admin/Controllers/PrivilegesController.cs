...
namespace ErpOnClick.Authorization.Areas.Admin.Controllers
{
    ...
    public class PrivilegesController : Controller
    {
        ...
        public PrivilegesController(ILogger<PrivilegesController> logger, INavigationService NavigationService, IModuleService ModuleService, IBranchService BranchService, ICompanyService CompanyService, IPrivilegesService PrivilegesService)
        {
            _logger = logger;
