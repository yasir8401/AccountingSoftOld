...
namespace ErpOnClick.Authorization.Areas.Admin.Controllers
{
    ...
    public class NavigationController : Controller
    {
        ...
        public NavigationController(ILogger<NavigationController> logger, IModuleService ModuleService, IWebHostEnvironment HostEnvironment, IBranchService BranchService, ICompanyService CompanyService, INavigationService NavigationService)
        {
            _logger = logger;
